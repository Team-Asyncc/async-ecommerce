    ...
    <div className="w-full h-full flex justify-center pt-12">
      <div className="w-1/3 h-1/2  flex flex-col items-center justify-between">
        ...
        <Link to="/Product" className="w-8/12">
          <button className="w-full mt-6 rounded border-pink-300 border-4 p-1 text-xl font-semibold text-pink-500 hover:text-gray-100 hover:bg-pink-500 hover:border-pink-500">
            CONTINUE SHOPPING
          </button>
        </Link>
      </div>
