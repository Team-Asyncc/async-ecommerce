...
export const cartSlice = createSlice({
  ...
  initialState : [{
    ...
    "description": "18 to 24 Months, Navy Blue round neck tee with back button and sequinned rainbow detailing",
    "price": 400,
    ...
    "description": "18 to 24 Months, A round neck top with soft elastic track pants for a cosy night for kids",
    "price": 549,
    ...
    "description": "12 to 18 Months, round neck pullover with three fourth sleeves frock with front buttons closure for girls",
    "price": 599,
    ...
    "description": "5 to 6 Years, Breezy and light bottoms for your baby's comfort with zig-zag print and knot belt",
    "price": 469,
